...
extension DietPlan {
    ...
    static var sample: DietPlan {
        DietPlan(
            ...
            description: "A balanced approach to weight loss emphasizing whole foods, adequate protein, and sustainable eating habits.",
            dailyCalories: 1800,
            macros: MacroTargets(
                proteinGrams: 135,
            ...
            mealTimingGuidelines: "Eat within 1 hour of waking, space meals 3-4 hours apart, finish eating 2-3 hours before bed.",
            snackingGuidelines: "If hungry between meals, choose protein-rich snacks like Greek yogurt, nuts, or hard-boiled eggs."
        )
    }
}
