...
extension HealthRecommendation {
  ...
  @MainActor static var sample: HealthRecommendation {
    let recommendation = HealthRecommendation(
      status: .completed,
      healthSummary:
        "Based on your profile, you're a 35-year-old male with prediabetes looking to lose weight and build muscle. Your current activity level is moderate, but there's room for improvement in sleep and stress management. Your goals are achievable with the right approach.",
      keyInsights: [
