...
struct SupplementPlan: Codable, Identifiable, Sendable {
    var id: UUID
...
enum SupplementTiming: String, Codable, CaseIterable, Identifiable, Sendable {
...
enum SupplementFrequency: String, Codable, CaseIterable, Identifiable, Sendable {
    case daily = "Daily"
...
enum SupplementPriority: String, Codable, CaseIterable, Identifiable, Sendable {
