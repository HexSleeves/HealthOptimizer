...
struct AIPromptBuilder {
    ...
    func buildUserPrompt(for profile: UserProfile) -> String {
        var prompt = "Please analyze the following health profile and generate comprehensive recommendations:\n\n"
        ...
        prompt += "- Fitness Level: \(profile.fitnessLevel.rawValue) - \(profile.fitnessLevel.description)\n"
