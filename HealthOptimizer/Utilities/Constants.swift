...
enum ValidationMessages {
    static let invalidAge = "Please enter a valid age between \(HealthConstants.minimumAge) and \(HealthConstants.maximumAge)."
    static let invalidHeight = "Please enter a valid height between \(Int(HealthConstants.minimumHeight)) and \(Int(HealthConstants.maximumHeight)) cm."
    static let invalidWeight = "Please enter a valid weight between \(Int(HealthConstants.minimumWeight)) and \(Int(HealthConstants.maximumWeight)) kg."
