        ...
        VStack(alignment: .leading, spacing: 16) {
          ...
          HStack(spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 4) {
              MacroRow(
                label: "Protein", grams: plan.macros.proteinGrams,
                percent: plan.macros.proteinPercentage, color: .red)
              MacroRow(
                label: "Carbs", grams: plan.macros.carbsGrams, percent: plan.macros.carbsPercentage,
                color: .blue)
              MacroRow(
                label: "Fat", grams: plan.macros.fatGrams, percent: plan.macros.fatPercentage,
                color: .yellow)
            }
          }
        }
