    ...
    var body: some View {
        NavigationStack {
            List {
                if let profile = profile {
                    ...
                    Section("Health Statistics") {
                        ...
                        StatRow(label: "BMI", value: String(format: "%.1f (%@)", profile.bmi, profile.bmiCategory.rawValue))
                    ...
                    if !profile.healthConditions.isEmpty && profile.healthConditions != [.none] {
                        Section("Health Conditions") {
                            ForEach(profile.healthConditions.filter { $0 != .none }, id: \.rawValue) { condition in
            ...
            .alert("Delete All Data?", isPresented: $showDeleteConfirmation) {
                ...
                Text("This will permanently delete your profile and all recommendations. This cannot be undone.")
            }
        ...
        List {
            ...
            Section("Data Storage") {
                PrivacyRow(
                    ...
                    description: "All your health data is stored locally on your device using encrypted storage."
                )
            ...
            Section("AI Processing") {
                PrivacyRow(
                    ...
                    description: "When generating recommendations, only health metrics are sent - never your name or identifying information."
                )
                
                PrivacyRow(
                    icon: "key",
                    title: "Your API Key",
                    description: "Your API key is stored in the secure iOS Keychain and used only for AI requests."
                )
            }
            ...
            Section {
                Text("HIPAA Notice: This app is designed with HIPAA-awareness in mind, but is not a covered entity. For medical decisions, always consult healthcare professionals.")
                    .font(.caption)
                    .foregroundColor(.secondary)
            }
        }
