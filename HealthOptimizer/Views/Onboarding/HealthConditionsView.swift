        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                SectionHeader(
                    ...
                    subtitle: "Select any conditions you currently have or have been diagnosed with. This helps us avoid contraindicated supplements and exercises."
                )
                ...
                HStack(spacing: 12) {
                    ...
                    Text("Always consult your healthcare provider before starting new supplements or exercise programs.")
                        .font(.caption)
                ...
                VStack(spacing: 0) {
                    ForEach(category.conditions) { condition in
                        Button(action: { onToggle(condition) }) {
                            HStack {
                                Image(systemName: selectedConditions.contains(condition) ? 
                                      "checkmark.circle.fill" : "circle")
                                    .foregroundColor(selectedConditions.contains(condition) ? 
