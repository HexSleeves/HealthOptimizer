    ...
    var body: some View {
        ScrollView {
            VStack(spacing: 24) {
                ...
                SectionHeader(
                    title: "Lifestyle",
                    subtitle: "Your daily habits significantly impact your health. This helps us give holistic recommendations."
                )
                ...
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    ForEach(OccupationType.allCases) { type in
                        Button(action: { viewModel.occupationType = type }) {
                            HStack {
                                Image(systemName: viewModel.occupationType == type ? 
                                      "checkmark.circle.fill" : "circle")
                                    .foregroundColor(viewModel.occupationType == type ? 
