        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                SectionHeader(
                    ...
                    subtitle: "Tell us what you're currently taking so we can check for interactions and avoid duplications."
                )
                ...
                HStack(spacing: 12) {
                    ...
                    Text("This information is crucial for safe supplement recommendations. Some supplements can interact with medications.")
                        .font(.caption)
